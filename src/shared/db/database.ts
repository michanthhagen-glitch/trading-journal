  ...
  weekly: [
    {
      ...
      account_id: "ACC-1",
      cadence: "weekly",
      title: "Week 26 - net +$1,842",
      period: "2026-06-23 -> 2026-06-29",
      body: "Solid week. Hit 4/6 setups, sized correctly, cut losers fast.",
    ...
    },
    {
      ...
      account_id: "ACC-1",
      cadence: "weekly",
      title: "Week 25 - net -$320",
      period: "2026-06-16 -> 2026-06-22",
      body: "Revenge-traded on Thursday. Need to revisit the cool-down rule.",
  ...
  monthly: [
    {
      ...
      account_id: "ACC-1",
      cadence: "monthly",
      title: "June 2026 - net +$3,210",
      period: "2026-06-01 -> 2026-06-30",
      body: "Best month in Q2. Win rate 61%, expectancy 0.74R.",
    ...
    },
    {
      ...
      account_id: "ACC-1",
      cadence: "monthly",
      title: "May 2026 - net +$1,180",
      period: "2026-05-01 -> 2026-05-31",
      body: "Slow start, strong back half. Best setups were London reversals.",
