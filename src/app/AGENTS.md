...
- Sidebar also receives a selected-account trading plan snapshot from shell state.
...
- The shell builds global search results and notification summaries from loaded account, strategy, educator, risk-plan, and trade data.
- Backtesting accounts do not receive live-trade missing recap or open-trade notifications.
